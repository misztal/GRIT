                              ...
                              )
{
  ...
  obj.m_dirichlet = elasticity::make_dirichlet( left_region, obj.m_triangles, obj.m_px0, obj.m_py0);
  ...
  obj.m_traction = elasticity::make_traction(right_region, obj.m_edges, obj.m_px0, obj.m_py0, 0.0, -1.0);
